...
HS300NextMonth = get_price('000300.XSHG',start_date=DateTransfer.nextmonthstart(date), end_date=DateTransfer.nextmonthend(date),
                            frequency='30d', fields=['open', 'close'])
rate2 = (HS300NextMonth['close'][0] - HS300NextMonth['open'][0]) / HS300NextMonth['open'][0]

HS300Next2Month = get_price('000300.XSHG',start_date=DateTransfer.nextmonthstart(date), end_date=DateTransfer.nextmonthend(date),
                   frequency='60d', fields=['open', 'close'])
rate3 = (HS300Next2Month['close'][0] - HS300Next2Month['open'][0]) / HS300Next2Month['open'][0]


print(HS300LastSeason)
print(rate1)
print(HS300NextMonth)
print(rate2)
print(HS300Next2Month)
print(rate3)



# HS300NextMonth = get_price('000300.XSHG',)
# HS300Next2Month = get_price()
#
# t = 0
# for i in mycsv['股票代码']:
#
...
#
#     df = pd.DataFrame(get_price(code, start_date=DateTransfer.nextmonthstart(date), end_date=DateTransfer.nextmonthend(date),
#                                 frequency='30d',fields=['open', 'close']))
...
#         break
#
# mycsv.to_csv('test111.csv',encoding= "gb2312",index=False)
